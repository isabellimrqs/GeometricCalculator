...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Olá " + nome + "! Seja bem vindo(a)! :D");

        System.out.println("Bom, " + nome + ", hoje vamos calcular área e perímetro de algumas formas geométricas...");

        try {
            System.out.println(nome + ", hoje você quer calcular figuras planas ou espaciais: \n 1 - Figuras Planas \n 2 - Figuras Espaciais");
            ...
            if (opcao == 1) {
                ...
                switch (opcaoFiguraEspacial) {
                    case 1 -> {
                        ...
                        System.out.println(cilindro.RetornaSringCilindro());
                    }
                    case 2 -> {
            ...
            System.out.println(nome + ", os valores devem ser números :C");
        }
